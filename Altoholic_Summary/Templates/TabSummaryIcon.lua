...
local function DataStoreOptionsIcon_Initialize(frame, level)
	...
	frame:AddButton("Auctions", 10, ShowOptionsCategory)
	frame:AddButton("Characters", 11, ShowOptionsCategory)
	frame:AddButton("Inventory", 12, ShowOptionsCategory)
	frame:AddButton("Mails", 13, ShowOptionsCategory)
	frame:AddButton("Quests", 14, ShowOptionsCategory)
